...
using TFCLPortal.Models.TokenAuth;
...
namespace TFCLPortal.Controllers
{
    ...
    public class TokenAuthController : TFCLPortalControllerBase
    {
        ...
        public async Task<AuthenticateResultModel> Authenticate([FromBody] AuthenticateModel model)
        {
            ...
            //Update for Android 10 Mobilization APK  Start

            if (model.AndroidID != "")
            {
                if (loginResult.User.IMEI == "" || loginResult.User.IMEI == null)
                {
                    User user = loginResult.User;
                    user.IMEI = model.AndroidID;
                }
            }

            //Update for Android 10 Mobilization APK  End
            ...
            if (branches.Count > 0)
            {
                ...
                {
                    if (branch.Id == loginResult.User.BranchId)
                    {
            ...
            return new AuthenticateResultModel
            {
                ...
                AndroidID = loginResult.User.IMEI
            };
        }
        ...
        private async Task<AbpLoginResult<Tenant, User>> GetLoginResultAsync(string usernameOrEmailAddress, string password, string androidId, string tenancyName)
        {
            var loginResult = await _logInManager.LoginAsync(usernameOrEmailAddress, password, tenancyName);
