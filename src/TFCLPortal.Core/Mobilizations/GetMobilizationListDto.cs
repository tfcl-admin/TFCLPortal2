...
namespace TFCLPortal.Mobilizations
{
    public class GetMobilizationListDto : FullAuditedEntity<Int32>
    {
        ...
        public string NextMeetingstr { get; set; }
