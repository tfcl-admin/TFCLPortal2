...
namespace TFCLPortal.BusinessDetailsTDS
{
    ...
    public class BusinessDetailTDS : FullAuditedEntity<int>
    {
        ...
        [ForeignKey("LegalStatus")]
        public BusinessLegalStatus BusinessLegalStatus { get; set; }
        [ForeignKey("NatureOfBusiness")]
        public NatureOfBusiness NatureOfBusinesses { get; set; }
        [ForeignKey("BusinessPlaceOwnership")]
        public OwnershipStatus BusinessPlacesOwnership { get; set; }
