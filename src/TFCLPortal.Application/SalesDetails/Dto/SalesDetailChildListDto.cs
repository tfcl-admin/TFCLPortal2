...
{
    [AutoMapFrom(typeof(SalesDetailChild))]
    public class SalesDetailChildListDto : EntityDto
    {
        ...
        public List<SalesDetailGrandChildListDto> SalesDetailGrandChild { get; set; }
