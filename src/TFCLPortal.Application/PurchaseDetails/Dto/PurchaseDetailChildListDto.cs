...
{
    [AutoMapFrom(typeof(PurchaseDetailChild))]
    public class PurchaseDetailChildListDto : EntityDto
    {
        ...
        public List<PurchaseDetailGrandChildListDto> PurchaseDetailGrandChild { get; set; }
