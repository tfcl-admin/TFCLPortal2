...
namespace TFCLPortal.BusinessDetails.Dto
{
    ...
    public class BusinessDetailDto : EntityDto
    {
        ...
        public string GenderOfTheStudentName { get; set; }
        public string SchoolPlaceOwnershipName { get; set; }
        public string RentAmount { get; set; }
        public List<SchoolBranchDto> school_Branches { get; set; }
