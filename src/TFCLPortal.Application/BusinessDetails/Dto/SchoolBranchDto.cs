...
{
    [AutoMapFrom(typeof(School_Branch))]
    public class SchoolBranchDto: Entity<int>
    {
        ...
        public string ClientBusinessClassificationName { get; set; }
        ...
        public string SchoolBranchBusinessNatureName { get; set; }
        public DateTime? EstablishedSince { get; set; }
        public DateTime? CurrentAddressSince { get; set; }
        public string BusinessAge { get; set; }
        public string AllowedMinBusinessAge { get; set; }
        public string CalculatedBusinessAge { get; set; }
        public string TimeAtCurrentAddress { get; set; }
        public string AllowedMinTimeAtCurrentAddress { get; set; }
        public string CalculatedTimeAtCurrentAddress { get; set; }
