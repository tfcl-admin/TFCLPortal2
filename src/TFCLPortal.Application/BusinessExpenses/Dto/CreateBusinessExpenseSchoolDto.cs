...
{
    [AutoMapTo(typeof(BusinessExpenseSchool))]
    public class CreateBusinessExpenseSchoolDto
    {
        ...
        public List<CreateBusinessExpenseSchoolClassesDto> businessExpenseSchoolClasses { get; set; }
        public List<CreateBusinessExpenseSchoolAcademiesDto> businessExpenseSchoolAcademies { get; set; }
