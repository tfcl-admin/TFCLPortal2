...
{
    [AutoMapTo(typeof(BusinessExpenseSchoolAcademy))]
    public class CreateBusinessExpenseSchoolAcademiesDto
    {
        ...
        public List<CreateBusinessExpenseSchoolAcademyClassesDto> businessExpenseSchoolAcademyClasses { get; set; }
