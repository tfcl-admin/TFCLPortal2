...
{
    [AutoMapFrom(typeof(TDSBusinessExpenseChild))]
    public class TDSBusinessExpenseChildListDto : EntityDto
    {
        ...
        public List<TDSBusinessExpenseGrandChildListDto> TDSBusinessExpenseGrandChilds { get; set; }
