...
//using TFCLPortal.TaleemDostSahulatProduct.BusinessDetailsTDS.Dto;
...
namespace TFCLPortal.TaleemDostSahulatProduct.CreateWrapperAllScreensOFTDS.Dto
{
    public class CreateAllScreenForTDSDto
    {
       ...
       public CreateSalesPurchaseTDSDto createSalePurchase { get; set; }
       //public CreateBusinessDetailTDSDto createBusinessDetail { get; set; }
      ...
      // public CreateHouseholdIncomeDto createHouseholdIncomeDetail { get; set; }
      ...
      // public CreateLoanEligibilityDto createLoanEligiblity { get; set; }
       public CreateFinancialInformationTDSDto createFinancialInformation { get; set; }
    }
}
